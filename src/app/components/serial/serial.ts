...
const kDefaultBufferSize = 64;
const kDefaultDataBits = 16;
    ...
    pull(controller: any): void {
        (async (): Promise<void> => {
            ...
            try {
                ...
                if (result.data?.buffer && result.data?.buffer?.byteLength > 0) {
...
export class SerialPort {
    public polyfillOptions_: SerialPolyfillOptions;
    public device_: USBDevice;
    public controlInterface_: USBInterface;
    public transferInterface_: USBInterface;
    public inEndpoint_: USBEndpoint;
    public outEndpoint_: USBEndpoint;

    public serialOptions_!: SerialOptions;
    public readable_!: ReadableStream<Uint8Array> | null;
    public writable_!: WritableStream<Uint8Array> | null;
    public outputSignals_!: any;
     ...
     * has been changed.
     */
    public async setSignals(signals: any): Promise<void> {
